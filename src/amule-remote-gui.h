...
protected:
        ...
        int m_full_req_cmd; ECTagNames m_full_req_tag;
...
public:
        ...
        */
        ...
        // be same class
        //
        void DoRequery(int cmd, ECTagNames tag) {
                if ( this->m_state != IDLE ) {
                        return;
                }
...
// 	uint32 GetPublicIP(); I2P : we have to chose between GetUdpDest and GetTcpDest
        ...
        bool NetworkStarting() {return m_ConnState & CONNECTED_NETWORK_STARTING;}
        bool NetworkStarted() {return  m_ConnState & CONNECTED_NETWORK_STARTED ;}
