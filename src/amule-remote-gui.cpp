...
{
        if (packet->GetOpCode() == EC_OP_KAD_CONTACTS_STRING and packet->GetTagByName(EC_TAG_KADEMLIA_FILENAME)!=0 and packet->GetTagByName(EC_TAG_KADEMLIA_CONTACTS_STRING)!=0)
	{
		try {
